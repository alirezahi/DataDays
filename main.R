...
model <- c("iphone", "samsung", "huawei", "nokia" ,"lenovo", "sony", "lg", "htc" ,"xiaomi", "alcatel", "galaxy", "motorola", "apple", "نوکیا", "آیفون", "سامسونگ", "هواوی","ال جی", "سونی", "لنوو","اچ تی سی","شیائومی","الکاتل", "گلکسی", "موتورولا", "اپل", "note2","note3","note4","note5","note6","note7","note8","نوت2","نوت7","نوت6","نوت5","نوت4","نوت3","نوت9","نوت8","j1","j2","j3","j4","j5","j6","j7","جی1","جی2","جی3","جی4","جی5","جی6","جی7","s3","s4","s5","s6","s7","s8","s9","اس3","اس4","اس5","اس6","اس7","اس8","اس9","z1","z10","lumia","a5","a6","a7","honor","nexus5", "nexus5x", "nexus6p", "nexus4", "nexus7", "نکسوس5","نکسوس5 ایکس","نکسوس4","نکسوس7", "zte","caterpillar","کاترپیلار","desire","دیزایر","زیمنس","siemens","هانر","g610","g620","g630","blackberry","amazon","sony ericsson","farassoo","dell","acer","asus","لومیا","فراسو","ایسوس","ایسوز","ایسر","اریکسون","بلک‌بری")
brand <- c("Apple::اپل", "Samsung::سامسونگ", "Huawei::هوآوی", "Nokia::نوکیا", "Lenovo::لنوو", "Sony::سونی", "LG::ال‌جی", "HTC::اچ‌تی‌سی", "xiaomi", "alcatel", "Samsung::سامسونگ", "Motorola::موتورلا", "Apple::اپل", "Nokia::نوکیا", "Apple::اپل", "Samsung::سامسونگ", "Huawei::هوآوی", "LG::ال‌جی", "Sony::سونی", "Lenovo::لنوو", "HTC::اچ‌تی‌سی", "xiaomi", "alcatel", "Samsung::سامسونگ", "Motorola::موتورلا","Apple::اپل", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "samSamsung::سامسونگsung", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Sony::سونی", "BlackBerry::بلک‌بری", "Nokia::نوکیا", "Samsung::سامسونگ", "Samsung::سامسونگ", "Samsung::سامسونگ", "Huawei::هوآوی", "LG::ال‌جی", "LG::ال‌جی", "Huawei::هوآوی", "LG::ال‌جی", "asus", "LG::ال‌جی", "LG::ال‌جی", "LG::ال‌جی", "asus", "ZTE::زدتی‌ای", "caterpillar", "caterpillar", "HTC::اچ‌تی‌سی", "HTC::اچ‌تی‌سی", "siemens", "siemens", "Huawei::هوآوی", "Huawei::هوآوی", "Huawei::هوآوی", "Huawei::هوآوی","BlackBerry::بلک‌بری","Amazon::آمازون", "Sony Ericsson::سونی اریکسون","Farassoo::فراسو","Dell::دل","Acer::ایسر","Asus::ایسوس","Nokia::نوکیا","Farassoo::فراسو","Asus::ایسوس","Asus::ایسوس","Acer::ایسر","Sony Ericsson::سونی اریکسون","BlackBerry::بلک‌بری")
...
brand_result$brand <- mapvalues(brand_result$model, from = model_replace, to = brand_replace)
...
substr_result$brand <- mapvalues(substr_result$mobile_type, from = model_replace, to = brand_replace)
...
brand_by_others$brand <- mapvalues(brand_by_others$model, from = model_replace, to = brand_replace)
